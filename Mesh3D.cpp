...
Mesh3D Mesh3D::triangle(const std::vector<Texture>& textures) {
	return Mesh3D(
		{ { -0.5, -0.5, 0., 0, 0, 1, 0., 1. },
		  { -0.5, 0.5, 0, 0, 0, 1, 0., 0. },
		  { 0.5, 0.5, 0, 0, 0, 1, 1, 0 } },
...
Mesh3D Mesh3D::cube(const std::vector<Texture>& textures) {
	std::vector<Vertex3D> verts = {
		/*BUR*/{ 0.5, 0.5, -0.5,  0, 0, -1, 1.0, 0},
		/*BUL*/{ -0.5, 0.5, -0.5, 0, 0, -1, 0, 0},
		/*BLL*/{ -0.5, -0.5, -0.5, 0, 0, -1, 0, 1.0 },
		/*BLR*/{ 0.5, -0.5, -0.5, 0, 0, -1, 1.0, 1.0},
	...
	return Mesh3D(std::move(verts), std::move(tris), std::vector<Texture>(textures));
}
